...
class Hasil extends BaseController
{
    ...
    public function userpauli() {
        ...
        $data["users"] = $this->usermodel->getUserHasilPauli($start_dttm,$end_dttm,$group_id,$materi_id)->getResult();
    ...
    public function getUserPauli() {
        ...
        $data = $this->usermodel->getUserHasilPauli($start_dttm,$end_dttm,$group_id,$materi_id)->getResult();
